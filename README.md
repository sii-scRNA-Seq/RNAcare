...
###### (3) If users don't need the activated labels anymore, they need disactivate those labels, after disactivation, the original labels (numerical one or the categorical one) will be back as independant variables.
